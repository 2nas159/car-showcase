...
```bash
git clone https://github.com/2nas159/car-showcase.git
cd car-showcase
```
...
Replace the placeholder values with your actual credentials. You can obtain these credentials by signing up on the corresponding websites from [Rapid API](https://rapidapi.com/apininjas/api/cars-by-api-ninjas) to [Imagin Cars](https://www.imagin.studio/solutions/api)
